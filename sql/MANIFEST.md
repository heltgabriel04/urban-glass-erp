...
| 2026-08-03 | `sql/lotes-estoque-refletivo-4mais4-carga-2026-08-03.sql` | lotes_estoque — cria lote confirmado (3660×2140mm, 50 chapas) do Refletivo 4+4 (produto 21), ajuste manual em `/estoque` não criava linha em `lotes_estoque` | ✅ |
| 2026-08-04 | `sql/ipi-orcamentos.sql` | IPI (6,5%) opcional nos orçamentos — mesmo padrão de `sql/ipi-pedidos.sql`; ao aprovar, tem_ipi/valor_ipi são copiados pro pedido gerado | ⏳ |
| 2026-08-12 | `sql/lotes-estoque-refletivo-4mais4-fume-carga-2026-08-12.sql` | Corrige duplicata acidental no produto 21 (re-execução indevida do script de 08/03) + cria lote confirmado (3300×2140mm, 500 chapas) do produto 20 (Refletivo 4+4 **Fumê** — produto diferente do 21) | ⏳ |
| 2026-08-13 | `sql/lotes-estoque-laminado-4mais4-light-gray-carga-2026-08-13.sql` | Soma 30 chapas novas ao agregado legado (18→48) + cria lote confirmado (3210×2400mm, 48 chapas) do produto 27 (Vidro Laminado 4+4 Light Gray) | ⏳ |
