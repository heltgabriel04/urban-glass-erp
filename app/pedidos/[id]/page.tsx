...
export default function PedidoDetalhe() {
  ...
  if (!pedido) {
    return (
      <AppLayout>
        <div className="con">
          <div style={{ color: "var(--err)", padding: "32px" }}>Pedido não encontrado.</div>
        </div>
      </AppLayout>
    );
  }
  ...
  const pctRec = pedido.valor_total > 0
    ? Math.min(100, (Number(pedido.valor_recebido) / Number(pedido.valor_total)) * 100)
    : 0;
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
          ...
          <div className="card" style={{ padding: "20px 24px" }}>
            ...
            {!quitado && (
              <div style={{ marginTop: "20px" }}>
                {!recebendo ? (
                  <button className="btn bp sm" style={{ width: "100%" }} onClick={() => setRecebendo(true)}>
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    <input
                      ...
                      style={{
                        ...
                        borderRadius: "6px", padding: "8px 12px", color: "var(--t1)", fontSize: "14px",
                      }}
                      autoFocus
                    />
